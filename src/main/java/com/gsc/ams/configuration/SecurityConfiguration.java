package com.gsc.ams.configuration;
	...
	public BCryptPasswordEncoder passwordEncoder() {
        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
            http
                ...
                .requestMatchers("/teacher/**").hasAnyAuthority("SUPERADMIN", "ADMIN")
                .requestMatchers("/pupil/**").hasAnyAuthority("USER", "ADMIN","SUPERADMIN").anyRequest()
